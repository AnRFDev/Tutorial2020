...
import com.rustfisher.mediasamples.databinding.MeActSimplePreivewXBinding;
 ...
 */
public class MeSimplePreviewXAct extends AppCompatActivity {
    private static final String TAG = "rfDevX";
    private MeActSimplePreivewXBinding mBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = DataBindingUtil.setContentView(this, R.layout.me_act_simple_preivew_x);
