...
public class CorrectPopupWindow {
    ...
    public CorrectPopupWindow(final Context context) {
        mContext = context;
        View contentView = LayoutInflater.from(context).inflate(R.layout.popup_correct_word_options, null);
        ...
        contentView.findViewById(R.id.insert_before).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onChooseCmd != null) {
                    onChooseCmd.insertBefore();
                }
            }
        });
        contentView.findViewById(R.id.replace).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onChooseCmd != null) {
                    onChooseCmd.replace();
        ...
        contentView.findViewById(R.id.del).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (onChooseCmd != null) {
                    onChooseCmd.del();
